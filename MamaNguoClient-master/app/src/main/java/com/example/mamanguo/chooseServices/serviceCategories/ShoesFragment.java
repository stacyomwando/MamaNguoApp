...
public class ShoesFragment extends Fragment implements RecyclerDataAdapter.ServicesSelectedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        init();
        recyclerDataAdapter = new RecyclerDataAdapter(ServicesLists.shoesList(mContext), this);
