...
public class BottomsFragment extends Fragment implements RecyclerDataAdapter.ServicesSelectedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        init();
        recyclerDataAdapter = new RecyclerDataAdapter(ServicesLists.bottomsList(mContext), this);
